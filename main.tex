...
\vspace{0.4cm}
\begin{abstract} 								% 5
\input{./sections/0_ringkasan.tex}
\end{abstract}
{\color{gray}\hrule}
\medskip
\input{./sections/1_pendahuluan.tex}			% 15
\input{./sections/2_alat-bahan.tex}				% 20
\input{./sections/3_prosedur-kerja.tex}		% 25
\input{./sections/4_hasil-pembahasan.tex}		% 25
\input{./sections/5_kesimpulan.tex}				%  5
